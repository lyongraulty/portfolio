...
export function InfoSection() {
  return (
    <Section id="info" size="small" containerClassName="info-layout" aria-labelledby="info-heading">
      <div className="info-text">
        ...
        <p>
          ...
          some incredible projects since starting in the industry in 2014. I&apos;ve been working freelance since 2016
          and before that I was working for two years on staff as a motion designer at a small shop here in Austin.
        </p>
        <p>
        ...
        <p>
          When I&apos;m not wrangling keyframes I&apos;m usually hanging out with my wife and daughters or making music.
          I play clarinet, tenor sax and guitar with the Relevators and Asleep at the Wheel and make my own electronic
          music. In a past life, I also produced a line of guitar effects pedals under the name Station Audio using acid
          etched graphics and found objects.
        </p>
        <p>
